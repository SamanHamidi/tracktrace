...
class Shipment(models.Model):
    ...
    article_price = models.DecimalField(
        blank=True, null=True, max_digits=10, decimal_places=2
    )
    sku = models.CharField(blank=True, null=True, max_length=5)
    status = models.CharField(
        blank=True, null=False, default="inbound-scan", max_length=16
    )
...
class Address(models.Model):
    ...
    country = models.CharField(
        blank=False, null=False, choices=CountryChoices.choices, max_length=16
    )
